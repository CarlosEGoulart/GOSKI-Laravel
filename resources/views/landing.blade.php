            ...
            <div class="flex flex-col items-start justify-center gap-3 py-24">
                <div class="text-start text-5xl font-normal leading-tight pb-8">
                    ...
                    <p>
                        ...
                        <span
                            class="bg-linear-to-l from-[#FF0000] via-[#AF054D] to-[#1B0EDB] bg-clip-text text-transparent">
                            mundo.
                        </span>
                        ...
                        <div class="flex flex-col items-center gap-4">
                            <div class="relative w-full">
                                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                    <img class="w-5 h-5 opacity-30" src="{{ asset('images/icons/icon.png') }}"
                                        alt="User Icon">
                                </div>
                            ...
                            <div class="relative w-full">
                                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                    <img class="w-5 h-5 opacity-30" src="{{ asset('images/icons/lock.png') }}"
                                        alt="Lock Icon">
                                </div>
