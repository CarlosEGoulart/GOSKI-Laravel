<div class='flex flex-row items-center justify-between gap-3 py-4'>
    <div class='flex items-center justify-start'>
        ...
        <h1 class='p-4 text-center text-2xl text-shadow-2xs'>{{ Auth::user()->username }}</h1>
    </div>
    <button
        class="inset-ring-1 inset-ring-white/5 w-l inline-flex cursor-pointer justify-center rounded-md bg-black px-3 py-2 text-sm font-semibold text-white hover:bg-black/30 shadow-xl">
        Meu Perfil
    </button>
</div>
