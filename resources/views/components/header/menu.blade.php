...
<el-dropdown class="inline-block">
  <button class="inline-flex inset-ring-1 inset-ring-white/5 justify-center gap-x-1.5 bg-black hover:bg-black/30 px-3 py-2 rounded-md w-full font-semibold text-white text-sm cursor-pointer">
    Opções
